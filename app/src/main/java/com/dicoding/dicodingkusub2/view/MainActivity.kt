...
import com.dicoding.dicodingkusub2.viewModel.ListDataUsersAdapter
import com.dicoding.dicodingkusub2.viewModel.userFilterList
...
class MainActivity : AppCompatActivity() {
    private var title: String = "Github User's Search"
    ...
    private fun getDataGitDetail(id: String) {
        ...
        val get = client.get(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(
                statusCode: Int,
                headers: Array<Header>,
                responseBody: ByteArray
